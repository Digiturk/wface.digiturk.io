...
import { WButton, WNestedPageLayout, WIcon } from '@wface/components'
import WNestedPageLayoutExample from './w-nested-page-layout-example'
...
interface WNestedPageLayoutExampleState {
  data: any;
  open: boolean;
  nestedPageState: any;
}
export class WNestedPageLayoutExample extends React.Component<WFace.BaseScreenProps, WNestedPageLayoutExampleState> {
